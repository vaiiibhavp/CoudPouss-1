      ...
      <DialogContent sx={{ p: 0 }}>
        ...
        >
          ...
          >
            ...
            >
              Your service has been successfully confirmed with the expert. Here
              are the payment and service details.
            </Typography>
          </Box>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
              ...
              >
                ...
                >
                  ...
                  <Button
                    onClick={() =>
                      router.push(`/about-professional/${providerId}`)
                    }
                    variant="outlined"
                    sx={{
                      borderRadius: "0.5rem",
            ...
            <Box>
              ...
              >
                <Box>
                  ...
                  >
                    CoadiPro doesn't guarantee the quality of services exchanged
                    from this point onward. Our role is to connect you with
                    professionals and securely store your transactions through
                    escrow. All services and payments outside the platform are
                    handled directly by the users. Once you provide the
