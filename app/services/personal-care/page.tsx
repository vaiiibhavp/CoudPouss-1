...
export default function PersonalCarePage() {
  ...
  // Personal care service cards data
    ...
    <Box sx={{ bgcolor: "background.default", minHeight: "100vh" }}>
      ...
      <Container maxWidth="lg" sx={{ py: 6 }}>
        ...
        >
          ...
          >
            {/* Left Side - Dark Teal Background with Text */}
            <Box
              sx={{
            ...
            >
              <Image
                src="/image/personal-care-hero-section.png"
        ...
        <Box>
          ...
          >
            {personalCareServices.map((service) => (
              <Card
                key={service.id}
                sx={{
                  borderRadius: 2,
